        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav1">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="http://rlmgz.esy.es/login.php">Login</a>
                    </li>
                ...
                <div class="row" id="home">
                    ...
                    <div class="col-lg-6">
                        <div class="description">
                            ...
                            <p class="wow fadeInLeft" data-wow-delay="0.4s">This is only a practice website by Roel Maglangit.</p>
                            <br>
